...
{
	/**
	 * @var va a contener la conexión de la base de datos
	 */
	protected $_con;
	...
	public function registration( array $data )
	{
		if( !empty( $data ) ){
			...
			// Verificar la direccion de email
	...
	/**
	 *Método para verificar los datos de la cuenta para el cambio de contraseña
	 * @param array $data
	 * @throws Exception
	 * @return boolean
	 */
	...
	public function forgetPassword( array $data )
	{
		if( !empty( $data ) ){
			...
			if(mysqli_query($this->_con, $query)){
				...
				$headers = "From: guillermo@email.com" . "\r\n" .
						"CC: guillermo@email.com";
